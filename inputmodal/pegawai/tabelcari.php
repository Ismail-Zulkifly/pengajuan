...
<div id="employee_table">
    <table id="table_peg" class="table table-bordered text-center">
        ...
        <tbody>
            ...
            $query = "SELECT * FROM pegawai WHERE nama LIKE '%" . $keyword . "%' ORDER BY nip ASC LIMIT $limit_start, $limit";
            ...
            ?>
                <tr>
                    ...
                    <td><input type="button" name="view" value="Lihat Detail" id="<?php echo $row["nip"]; ?>" class="btn btn-info btn-xs view_data" /></td>
